...
Common labelsdb
*/}}
{{- define "ordersdb.labels" -}}
{{ include "ordersdb.selectorLabels" . }}
{{- end }}

{{/*
Selector labelsdb
*/}}
{{- define "ordersdb.selectorLabels" -}}
app.kubernetes.io/name: {{ include "orders.name" . }}-db
{{- end }}
...
Create the name of the service account to use
*/}}
{{- define "ordersdb.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
